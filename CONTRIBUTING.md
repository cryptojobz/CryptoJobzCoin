Contributing to CJZcoin Core
============================

The CJZcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CJZcoin Core project, and is not to be
confused with overall CJZcoin Network Protocol consensus changes.

Whether a pull request is merged into CJZcoin Core rests with the project merge
...
Patches that change CJZcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CJZcoin consensus, it must have been
...
The project leader is the release manager for each CJZcoin Core release.
