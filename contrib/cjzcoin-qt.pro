...
RESOURCES += src/qt/cjzcoin.qrc src/qt/cjzcoin_locale.qrc

TRANSLATIONS += src/qt/locale/cjzcoin_bg.ts \
                src/qt/locale/cjzcoin_de.ts \
                src/qt/locale/cjzcoin_en.ts \
                src/qt/locale/cjzcoin_es.ts \
                src/qt/locale/cjzcoin_fi.ts \
                src/qt/locale/cjzcoin_fr.ts \
                src/qt/locale/cjzcoin_it.ts \
                src/qt/locale/cjzcoin_ja.ts \
                src/qt/locale/cjzcoin_pl.ts \
                src/qt/locale/cjzcoin_pt.ts \
                src/qt/locale/cjzcoin_ru.ts \
                src/qt/locale/cjzcoin_sk.ts \
                src/qt/locale/cjzcoin_sv.ts \
                src/qt/locale/cjzcoin_vi.ts \
                src/qt/locale/cjzcoin_zh_CN.ts \
                src/qt/locale/cjzcoin_zh_TW.ts
