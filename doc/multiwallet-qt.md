...
In order to support loading of multiple wallets in cjzcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cjzcoin.cpp.
...
Changes to cjzcoin.cpp
----------------------
cjzcoin.cpp is the entry point into cjzcoin-qt, and as such, will require some minor modifications to provide hooks for
