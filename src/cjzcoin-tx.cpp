...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CJZcoin Core cjzcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cjzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cjzcoin transaction") + "\n" +
                               "  cjzcoin-tx [options] -create [commands]   " + _("Create hex-encoded cjzcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cjzcoin transaction
