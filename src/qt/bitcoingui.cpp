                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CJZcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CJZcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cjzcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCJZ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CJZcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CJZcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CJZcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CJZcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CJZcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CJZcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CJZcoin Core help message to get a list with possible CJZcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CJZcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CJZcoin network", "", count));
}
...
{
    QString strTitle = tr("CJZcoin Core"); // default title
...
/** Creates context menu, its actions, and cjzcoins up all the relevant signals for mouse events. */
