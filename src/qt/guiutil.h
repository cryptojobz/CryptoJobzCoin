...
/** Utility functions used by the CJZcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CJZcoin addresses in monospace font
...
// Parse "cjzcoin:" URI into recipient object, return true on successful parsing
