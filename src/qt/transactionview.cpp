                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received CJZcoin from zCJZ"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCJZ"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCJZ));
