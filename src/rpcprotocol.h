...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! CJZcoin is not connected
    ...
    RPC_WALLET_PASSCJZCOINASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
