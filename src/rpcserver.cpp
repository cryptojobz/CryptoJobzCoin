...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "CJZcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CJZcoin features */
        {"cjzcoin", "masternode", &masternode, true, true, false},
        {"cjzcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cjzcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cjzcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cjzcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cjzcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cjzcoin", "startmasternode", &startmasternode, true, true, false},
        {"cjzcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cjzcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cjzcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cjzcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cjzcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cjzcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cjzcoin", "mnbudget", &mnbudget, true, true, false},
        {"cjzcoin", "preparebudget", &preparebudget, true, true, false},
        {"cjzcoin", "submitbudget", &submitbudget, true, true, false},
        {"cjzcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cjzcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cjzcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cjzcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cjzcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cjzcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cjzcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cjzcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cjzcoin", "mnsync", &mnsync, true, true, false},
        {"cjzcoin", "spork", &spork, true, true, false},
        {"cjzcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cjzcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cjzcoind, or the -server option to cjzcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cjzcoin-cli " + methodname + " " + args + "\n";
}
